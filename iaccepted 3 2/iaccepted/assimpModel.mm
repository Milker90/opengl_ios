...
//        }
        ...
        this->meshs[i].draw(material->texture);
...
{
//    GLuint positionLoc = glGetAttribLocation(program, "vposition");
//    GLuint normalLoc = glGetAttribLocation(program, "vnormal");
//    GLuint textcoordLoc = glGetAttribLocation(program, "textcoord");
...
void Model::processMesh(aiMesh *mesh)
{
    ...
    meshs.back().cntIndex = indices.size();
